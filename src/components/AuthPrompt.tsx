...
`}
      ...
      <p className="text-xl text-gray-300 text-center max-w-2xl mb-8">
        TuTasks is a simple yet powerful task management application that leverages Google Sheets as its backend.
        It allows you to manage your tasks directly within a spreadsheet, providing a familiar and flexible way to organize your work.
        No complex databases, just the power of Google Sheets.
      </p>
      <button
